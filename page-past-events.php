...
<div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
      ...
      <div class="page-banner__intro">
        <p>Check Our All Past Events Here</p>
      </div>
    </div>  
  </div>
  ...
  <?php 
        $today = date('Ymd');
        $past_page_events = new WP_Query(array(
          'posts_per_page' => 1,
          'post_type' =>'event',
          'meta_key' => 'event_date',
        ...
        while( $past_page_events->have_posts( )){

            $past_page_events->the_post(  ); ?>
          ...
          <?php paginate_links(
                array('total' => $past_page_events->max_num_pages )); ?>
          <?php
        }
